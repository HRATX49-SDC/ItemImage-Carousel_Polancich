...
export default function Improve({ displayImprove, toggleImprove }) {
  //if the customer clicked on the feedback link, display the form
  if(displayImprove) {
    return (
      <div className={styles.improveForm}>
        <form onSubmit={(e) => { toggleImprove(e) }}>
          {/* Start of checkboxes Section */}
          ...
          <div className={styles.checkboxRow}>
            <label className={styles.label} htmlFor='checkAvailabilityBeforeStoreTrip'>
              <input
              type="checkbox"
              id='checkAvailabilityBeforeStoreTrip'
              name='checkAvailabilityBeforeStoreTrip'
          ...
          <div className={styles.checkboxRow}>
            <label className={styles.label} htmlFor='buyOnlineAndPickupStore'>
              <input
              type="checkbox"
              id='buyOnlineAndPickupStore'
              name='buyOnlineAndPickupStore'
              className={styles.checkbox}
          ...
          <div className={styles.checkboxRow}>
            <label className={styles.label} htmlFor='buyOnlineAndGetShipped'>
              <input
              type="checkbox"
              id='buyOnlineAndGetShipped'
              name='buyOnlineAndGetShipped'
              className={styles.checkbox}
              />
          ...
          {/* Start of Improve TextArea Section */}
          ...
          {/* End of Improve TextArea Section  */}
          {/* Submit button below */}
